package org.engine.loaders.md5;

import org.engine.graph.anim.AnimVertex;
...
public class MD5Loader {
     ...
     * @throws Exception
     */
    public static AnimGameElement process(MD5Model md5Model, MD5AnimModel animModel, Vector3f defaultColor) throws Exception {
        ...
        AnimGameElement result = new AnimGameElement(meshes, animatedFrames, invJointMatrices);
        return result;
    }
