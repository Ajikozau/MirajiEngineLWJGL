...
public class InstancedMesh extends Mesh {
    ...
    public void renderListInstanced(List<GameElement> gameItems, Transformation transformation, Matrix4f viewMatrix, Matrix4f lightViewMatrix) {
        renderListInstanced(gameItems, false, transformation, viewMatrix, lightViewMatrix);
    }

    public void renderListInstanced(List<GameElement> gameItems, boolean billBoard, Transformation transformation, Matrix4f viewMatrix, Matrix4f lightViewMatrix) {
        initRender();
        ...
        for (int i = 0; i < length; i += chunkSize) {
            ...
            List<GameElement> subList = gameItems.subList(i, end);
    ...
    private void renderChunkInstanced(List<GameElement> gameItems, boolean billBoard, Transformation transformation, Matrix4f viewMatrix, Matrix4f lightViewMatrix) {
