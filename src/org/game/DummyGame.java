...
public class DummyGame implements IGameLogic {
    ...
    private Set<GameElement> gameItems;
    ...
    public void init(Window window) throws Exception {
        ...
        this.scene.setParticleEmitters(emitters);
    ...
    public void update(float interval, MouseInput mouseInput, Window window) {
        ...
        if (aux && !leftButtonPressed && selectDetector.selectGameItem(gameItems, window, mouseInput.getCurrentPos(), camera)) {
            this.hud.incCounter();
        }
